...
//         var uow = new EFUnitOfWork(new KaerMorhenDBContext(_options));
//         var mockProvider = new EFUnitOfWorkProvider(new DbContextFactory<KaerMorhenDBContext>(IServiceProvider));
//         mockProvider.Setup(prov => prov.CreateUow()).Returns(uow);
//         mockProvider.Setup(prov => prov.GetUow()).Returns(uow);
//         dbContextProvider = mockProvider.Object;
//     }
//
//     [Fact]
