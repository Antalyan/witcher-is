...
public class ContractServiceTest
{
    ...
    {
        var mockUnitOfWork = new Mock<IUnitOfWorkContracts>();
        var mockQueryObject = new Mock<IContractQueryObject>();
       

        mockUnitOfWork.Setup(uow => uow.ContractRepository.GetAll().Result)
            .Returns(_allContracts)
           ;
        var contractService = new ContractService(mockUnitOfWork.Object, mockQueryObject.Object);
    ...
    public async Task CreateContractAsync_Valid_CallsRepositoryInsert()
    {
        ...
        mockUnitOfWork.Setup(uow => uow.ContractRepository.Insert(It.IsAny<Contract>()))
    ...
    public async Task UpdateContractAsync_Valid_CallsUpdate()
    {
        ...
        mockUnitOfWork.Setup(uow => uow.ContractRepository.Update(It.IsAny<Contract>()))
            .Verifiable();
        ...
        mockUnitOfWork.Verify(mow => mow.ContractRepository.Update(It.IsAny<Contract>()), Times.Once);
    }
    ...
    public async Task DeleteContractAsync_Deletes()
    {
        ...
        mockUnitOfWork.Setup(uow => uow.ContractRepository.Delete(_jennyOTheWoods.Id))
